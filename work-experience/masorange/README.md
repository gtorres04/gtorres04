...
**Role:** Senior Backend Engineer (Java/Go) — Freelance
**Period:** January 2026 - March 2026 (3 months)
**Location:** Full Remote
**Client:** MasOrange (Telco) — mas-collections Project
...
- **Source control & Build:** GitHub (monorepo), Bazel
...
**Cargo:** Senior Backend Engineer (Java/Go) — Freelance
**Período:** enero de 2026 - marzo de 2026 (3 meses)
**Ubicación:** Full Remote
**Cliente:** MasOrange (Telco) — Proyecto mas-collections
...
- **Control de versiones y build:** GitHub (monorepo), Bazel
- **IDEs:** IntelliJ IDEA, VSCode
- **Analítica y BI:** BigQuery, Looker Studio
