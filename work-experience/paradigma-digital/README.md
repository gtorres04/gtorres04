...
**Period:** April 2021 - March 2024 (3 years)
**Location:** Madrid, Community of Madrid, Spain

---

I technically led backend teams in institutional and corporate projects, defining architectures, standards, and key decisions in critical platforms for public administrations and large companies.
...
Developed the backend for MasterCard processing modernization, integrating ISO 8583 messages via Netty and MongoDB in a mission-critical environment. Overcame the challenge of combining proprietary business rules without compromising protocol compatibility, reinforcing stability, transactional precision, and financial compliance.
...
- **Protocols:** ISO 8583, Netty, OpenAPI
- **Deployment:** OpenShift, Kubernetes (Sentinel)
...
**Período:** abril de 2021 - marzo de 2024 (3 años)
...
- **Despliegue:** OpenShift, Kubernetes (Sentinel)
- **CI/CD:** GitHub Actions, Jenkins, SonarQube
- **Testing:** JUnit, Karate, ICaRUS, mutation tests
